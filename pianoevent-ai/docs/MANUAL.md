...
- 윈도우 — `PianoEvent-Setup-Windows.exe`
- 맥 — `PianoEvent-Mac.dmg`

**「PianoEvent-Setup-Windows.exe」를 두 번 클릭하고, 다음 · 다음 · 설치.** 그게 전부입니다.

- 바탕화면과 시작 메뉴에 **「피아노이벤트」 아이콘**이 생깁니다. 그 아이콘을 누르면 프로그램 창이 뜹니다.
...
> 담기기 때문입니다. 어디인지 궁금하시면 메뉴에서 **[피아노이벤트 → 학원 자료 폴더 열기]**.

맥은 **「PianoEvent-Mac.dmg」** 를 열고 응용 프로그램 폴더로 끌어다 놓으시면 됩니다.
