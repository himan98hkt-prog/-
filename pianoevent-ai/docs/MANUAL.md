...
![학생 명단 화면 — 위쪽이 양식 안내, 가운데가 엑셀 파일 놓는 자리입니다](../public/manual/roster.jpg)
...
표의 칸을 고치시면 그 위에 **방금 고치신 것**이 한 줄 뜹니다.

> 방금 고치신 것 — **김서연 · 연주곡** (소나티네 → 엘리제를 위하여)  **[되돌리기]**
...
![순서표 · 대본 화면 — AI 순서표 만들기 한 번이면 아래가 전부 채워집니다](../public/manual/program.jpg)
...
![인쇄물 디자인 화면 — 왼쪽에서 고르면 오른쪽 미리보기가 바로 바뀝니다](../public/manual/design.jpg)
...
![종이로 보기 — 종이 몇 장인지 먼저 세어 주고, 잘리는 자리에 점선을 긋습니다](../public/manual/print.jpg)
...
| 무엇 | 어디 | 종이 미리보기 |
|---|---|---|
| 포스터 · 프로그램 · 순서지 등 40종 | 인쇄물 디자인 → **인쇄 · PDF** | 화면이 곧 종이입니다 |
...
![감동영상 화면 — 오른쪽 위 "이대로 만드셔도 됩니다" 부터 보세요](../public/manual/video.jpg)
...
사진을 **화면 꽉** 채울지, **액자에 담아 배경 위에** 얹을지 고릅니다.
...
![설정 화면 — 학원 정보, 이미지 보관함, 자동 저장이 여기 있습니다](../public/manual/settings.jpg)
...
**Q. 표에서 엉뚱한 칸을 고쳤습니다.**
A. 표 위에 **[되돌리기]** 가 떠 있습니다. 무엇을 무엇으로 되돌리는지 적혀 있으니
보시고 누르세요. **열 번까지** 거슬러 올라갑니다.
