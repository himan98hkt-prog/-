...
- **양식 59종** — 위쪽 갈래(포스터 · 프로그램 · 초대·홍보 · 행사 당일 · 진행 문서)를 먼저 누르면
  ...
  포스터 갈래의 **셋째 줄부터 여덟 장**이 예술회관식 포스터입니다. 「디자인이 너무 단순하다」는
  말씀을 듣고 새로 그린 것들입니다.

  | 양식 | 어떤 그림인가 |
  |---|---|
  | 그랜드피아노 | 어두운 무대 위 피아노가 종이 밖으로 흘러 나갑니다. 가장 무난합니다 |
  | 건반 무대 | 건반이 종이 아래를 가로지릅니다. 보는 사람이 피아노 앞에 앉은 자리에 섭니다 |
  | 무대 조명 | 위에서 내려오는 빛 한 줄기 안에 제목이 섭니다. 제목이 가장 큰 판입니다 |
  | 무대 아치 | 커튼이 걷힌 무대가 제목을 감쌉니다 |
  | 큰 날짜 편집 | 날짜를 아주 큰 숫자로 세운 비대칭 판. 밝은 바탕 |
  | 사진 전면 (고급) | 학원 사진이 종이를 가득 채우고 글이 그 위에 얹힙니다 |
  | 월계관 (콩쿠르) | 월계관 안에 연도. 시상이 있는 연주회에 |
  | 여백 | 제목 하나로 끝내는 미술관 포스터 문법 |

  > 손보실 것은 없습니다. 제목이 길면 **글씨 크기가 알아서 줄어듭니다.** 어느 테마를 고르셔도
  > 글씨가 안 보이는 일은 없습니다 — 이 여덟 장은 바탕색을 스스로 정합니다.
