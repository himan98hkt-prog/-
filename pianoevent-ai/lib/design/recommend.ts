 ...
 * 인쇄물을 **미리 정해 드린다.**
 *
 * 지금까지 인쇄물 화면은 원장님께 두 가지를 물었다 — 양식 64종 중 무엇, 테마 108종 중 무엇.
 ...
 * 108종을 펼치면 처음으로 돌아간다. 사람이 한눈에 견주는 수는 **셋**이다.
 *
...
export function recommendDesigns(input: {
  ...
  // 화려한 쪽은 예술회관 색으로 — "이 정도 나오나" 를 세 번째 카드에서 바로 보시게 한다
  add(
    'fancy',
    pickFamily('gala', used) ?? pickFamily('classic', used),
    '화려한 쪽',
    '예술회관 연주회 포스터의 색입니다. 깊은 바탕에 금 한 줄.',
  )
