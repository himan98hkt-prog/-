...
/**
 * 목록에 이름만 늘어놓으면 열네 가지를 못 고르신다.
 * 그래서 **어디에 사진이 오고 어디에 글이 오는지**를 작은 그림으로 그려 준다.
 * 그리는 데 필요한 것은 네모 두 개의 자리뿐이다 (0~1 의 비율).
 */
...
export const STAGE_LAYOUTS: StageLayoutInfo[] = [
  {
    ...
    needsPhoto: true,
    sketch: { photo: { x: 0.3, y: 0.28, w: 0.4, h: 0.5 }, text: { x: 0.1, y: 0.08, w: 0.8, h: 0.14 } },
  },
  {
    id: 'photo-side',
    name: '사진 반쪽 · 글 오른쪽',
    ...
    needsPhoto: true,
    sketch: { photo: { x: 0, y: 0, w: 0.5, h: 1 }, text: { x: 0.56, y: 0.16, w: 0.38, h: 0.4 } },
  },
  {
    id: 'photo-panel',
    name: '사진 전체 · 오른쪽 판',
    ...
    needsPhoto: true,
    sketch: { photo: { x: 0, y: 0, w: 1, h: 1 }, text: { x: 0.55, y: 0.1, w: 0.4, h: 0.5 } },
  },
  {
    id: 'photo-band',
    name: '사진 전체 · 위쪽 띠',
    ...
    needsPhoto: true,
    sketch: { photo: { x: 0, y: 0, w: 1, h: 1 }, text: { x: 0.06, y: 0.06, w: 0.88, h: 0.24 } },
  },
  {
    id: 'photo-corner',
    name: '사진 전체 · 큰 번호',
    ...
    needsPhoto: true,
    sketch: { photo: { x: 0, y: 0, w: 1, h: 1 }, text: { x: 0.06, y: 0.08, w: 0.5, h: 0.3 } },
  },
  {
    id: 'photo-split',
    name: '위 글 · 아래 사진',
    ...
    needsPhoto: true,
    sketch: { photo: { x: 0, y: 0.46, w: 1, h: 0.54 }, text: { x: 0.08, y: 0.1, w: 0.7, h: 0.26 } },
  },
  {
    id: 'photo-badge',
    name: '사진 전체 · 번호 배지',
    ...
    needsPhoto: true,
    sketch: { photo: { x: 0, y: 0, w: 1, h: 1 }, text: { x: 0.08, y: 0.08, w: 0.7, h: 0.22 } },
  },
  {
    id: 'photo-card',
    name: '사진 전체 · 오른쪽 카드',
    ...
    needsPhoto: true,
    sketch: { photo: { x: 0, y: 0, w: 1, h: 1 }, text: { x: 0.5, y: 0.1, w: 0.44, h: 0.44 } },
  },
  {
    id: 'text-hero',
    name: '이름만 크게',
    ...
    needsPhoto: false,
    sketch: { text: { x: 0.15, y: 0.32, w: 0.7, h: 0.28 } },
  },
  {
    id: 'text-number',
    name: '큰 번호 · 이름',
    ...
    needsPhoto: false,
    sketch: { text: { x: 0.32, y: 0.28, w: 0.6, h: 0.36 } },
  },
  {
    id: 'text-card',
    name: '이름 · 곡 · 해설 카드',
    ...
    needsPhoto: false,
    sketch: { text: { x: 0.12, y: 0.22, w: 0.76, h: 0.48 } },
  },
  {
    id: 'text-two-line',
    name: '이름 · 곡 두 줄',
    ...
    needsPhoto: false,
    sketch: { text: { x: 0.08, y: 0.3, w: 0.8, h: 0.34 } },
  },
  {
    id: 'text-frame',
    name: '액자 테두리',
    ...
    needsPhoto: false,
    sketch: { text: { x: 0.2, y: 0.3, w: 0.6, h: 0.3 } },
  },
  {
    id: 'text-marquee',
    name: '띠 · 이름 크게',
    ...
    needsPhoto: false,
    sketch: { text: { x: 0.08, y: 0.34, w: 0.78, h: 0.3 } },
  },
]
