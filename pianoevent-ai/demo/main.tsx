    ...
    <>
      ...
      <div className="proscenium">
        <div className="shell">
          <Stage
            n="5"
            title="인쇄물"
            lead="양식 59종 × 테마 108종. 고르는 즉시 오른쪽 종이가 바뀝니다. 실제 A4 크기 그대로 그린 것을 축소해 보여 줍니다."
            wide
          >
      ...
      <main className="shell">
        <Stage
          n="6"
          title="무대 화면 — 연주회 PPT"
          lead="해마다 파워포인트로 다시 만들던 화면입니다. 위에 넣은 명단 그대로 16:9 슬라이드가 통째로 만들어집니다. 위에서 테마를 바꿔 보세요 — 이 화면도 같이 바뀝니다."
          wide
        >
          <div className="deck">
            ...
            <p className="deck__note">
              ...
              {' · '}명단을 고치면 이 화면도 같이 바뀝니다. 실제 프로그램에서는 전체화면으로 띄우고, <b>진짜 .pptx
              파일</b>로 받아 파워포인트에서 바로 고칠 수 있습니다.
            </p>
          </div>
        </Stage>
        ...
        <div className="shell">
          ...
          <div className="close__grid">
            ...
            <div>
              <b>연주회 PPT를 파일로</b>
              <p>
                무대 화면을 <b>진짜 .pptx 파일</b>로 받습니다. 슬라이드가 그림이 아니라 글상자라 파워포인트에서 바로
                고칠 수 있고, 고른 테마의 색과 서체가 그대로 들어갑니다. PDF로도 받습니다.
              </p>
            </div>
            <div>
              <b>인쇄와 PDF 저장</b>
