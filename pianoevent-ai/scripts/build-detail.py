  ...
  <div class="inner">
    ...
    <div class="card reveal" style="--d:0.35s">
      ...
      <div class="stat-row">
        ...
        <div class="stat"><p class="v">75종</p><p class="k">인쇄물 양식</p></div>
...
<section class="usp">
  <div class="inner">
    ...
    <div class="numbers reveal" style="--d:0.15s">
      ...
      <div><p class="v">75종</p><p class="k">인쇄물 양식</p></div>
...
<section class="guide">
  <div class="inner">
    ...
    <div class="chain reveal" style="--d:0.22s">
      ...
      <p class="last">순서 하나를 바꾸면 &mdash; 위의 <b>75종이 동시에</b> 다시 만들어집니다</p>
    </div>
  </div>
</section>
    ...
    <div class="scope-grid">
      <div class="scope-col yes reveal">
        ...
        <ul>
          ...
          <li><span class="scope-mark">&#10003;</span><span><b>인쇄물 75종 &times; 테마 108종</b> &middot; 포스터부터 좌석 배치도, 진행 문서까지</span></li>
      ...
      <table class="cmp">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="ours">75종이 함께 즉시 변경</td>
          </tr>
          <tr>
            <th>학생 이름 입력</th>
            <td>양식마다 반복</td>
            <td>양식마다 반복 타이핑</td>
            <td>파일로 전달</td>
            <td class="ours">한 번 &rarr; 75종에 자동</td>
          </tr>
          <tr>
            <th>사회자 대본</th>
            <td>밤새 타이핑</td>
