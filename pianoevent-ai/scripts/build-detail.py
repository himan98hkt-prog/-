...
<section class="reality">
  <div class="inner">
    ...
    <div class="steps">
      ...
      <div class="step reveal" style="--d:0.32s"><div class="when">5<small>뽑기</small></div><div class="what"><b>30초만 먼저 만들어 보고, 그다음 전체</b><span>요즘 크롬 &middot; 엣지에서는 화면을 거치지 않고 담기 때문에 <strong>영상 길이의 3분의 1 아래로</strong> 끝납니다(12분짜리가 3분 안팎). 그동안 다른 창을 보셔도 끊기지 않습니다. 오래된 브라우저에서는 예전처럼 실제 길이만큼 걸리는데, 그때를 위해 <strong>[30초만 먼저 만들어 보기]</strong>를 옆에 두었습니다 &mdash; 앞 &middot; 가운데 &middot; 끝에서 한 장면씩 이어 붙여 30초로 보여 드립니다. 어느 쪽인지는 <strong>만들기 전에 화면에 적어</strong> 드립니다.</span><span class="out">나오는 것 &middot; MP4 또는 WebM 파일</span></div></div>
    </div>
