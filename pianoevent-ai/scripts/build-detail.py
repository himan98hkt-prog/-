...
<section class="guide">
  <div class="inner">
    ...
    <div class="notice reveal" style="--d:0.32s">
      <p class="n-title">&#127912; 테마 100종, 그 자리에서 바꿉니다</p>
      <p>인쇄물에 쓰던 <strong>테마 100종이 그대로</strong> 나옵니다. 행사 달에 어울리는 테마를 먼저 보여 주고,
  ...
  <div class="inner">
    ...
    <div class="feat-grid">
      ...
      <div class="feat reveal" style="--d:0.16s">
        ...
        <b>만들기 전에 장면 전부가 그림으로 뜹니다</b> &mdash; 설명이 아니라 실제로 나올 그 화면입니다.</p>
