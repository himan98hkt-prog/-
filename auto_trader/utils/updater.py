...
SHIPPED_DEFAULTS: dict[str, set[str]] = {
    "config/settings.yaml": {
        "bf564c59ba53b94ff0990470feced0261301503b745adb27aae57ecbf3fdd212",
    ...
    # 영영 .new 로만 떨어지고 봇은 추석에도 계속 돈다.
    "config/holidays.txt": {
        # 날짜가 하나도 없던 최초 버전 (예시 주석만 있던 파일)
        "709fe88fc1160ad61e87a14afb579e979efa690c5ca35df99709e55d520cd53c",
        # 2026년 휴장일 17일을 채운 버전
        "c52aed7dd7fd1866487e88e624114085a6847b55ad1234e0bf32864634c0bef9",
    },
}
