...
PLACES: list[tuple[tuple[str, ...], str]] = [
    ...
    # 3인칭 월드 팩(PROMPTS_WORLD)이 쓰는 지형. 역시 넓은 말보다 먼저 본다.
    (("hillside town", "hillside street", "terraced village",
      "cliffside village"), "언덕 마을"),
    (("cloud bridge", "sky road", "skyway"), "구름 다리"),
    (("dune", "sand sea"), "모래언덕"),
    (("crater",), "분화구"),
    (("salt flat", "salt desert"), "소금 사막"),
    (("cliff path", "clifftop", "cliff edge"), "벼랑길"),
    (("archipelago", "island chain"), "섬"),
