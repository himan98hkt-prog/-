...
export const CARD_THEMES: CardTheme[] = [
  ...
  {
    key: 'night',
    nameKey: 'cardTheme.night',
    pro: false,
    bubbleBg: 'rgba(20,22,30,0.88)',
    bubbleText: '#FFFFFF',
    accent: '#FFB627',
    scrim: 0.45,
    shape: 'round',
  ...
  {
    key: 'retro',
    nameKey: 'cardTheme.retro',
    pro: true,
    bubbleBg: 'rgba(255,248,231,0.92)',
    bubbleText: '#4A3B2A',
    accent: '#C2703D',
    scrim: 0.4,
    shape: 'sharp',
