...
아래 시스템 지시를 따르고, **맨 아래 JSON 스키마에 맞는 JSON 하나만** 다음 파일에 써라.
    ...
    /home/user/-/concours-composer/runs/golden/g03/phrase_17_20_response.json

17~20마디만 만든다. 각 성부의 dur 합계는 정확히 한 마디여야 하고, 동시 타건 폭은 12반음 이하, 음역은 36~96 안이어야 한다. 왼손 최고음이 오른손 최저음을 넘으면 안 된다.
