...
아래 시스템 지시를 따르고, **맨 아래 JSON 스키마에 맞는 JSON 하나만** 다음 파일에 써라.
    ...
    /home/user/-/concours-composer/runs/golden/g03/plan_response.json

제안 마디 수 60. 프레이즈는 4마디 단위로 끊고 total_measures 를 빠짐없이 덮어야 한다. 클라이맥스는 전체의 60~80% 지점.
